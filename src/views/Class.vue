...
// 模拟数据
const professionalDirections = ['语文学科', '数学学科', '英语学科', '中文学科', '电工电气', '数码产品'];
const studyHours = ['1-5', '6-10', '11-15', '16-20'];
const courses = [
  {
...
<template>
    ...
    <el-main class="main">
      ...
      <div class="filter">
        <span>专业方向</span>
        <el-button v-for="(direction, index) in professionalDirections" :key="index" type="text" size="small">
          {{ direction }}
        </el-button>
        <span>学时</span>
        <el-button v-for="(hours, index) in studyHours" :key="index" type="text" size="small">
          {{ hours }}学时
        </el-button>
